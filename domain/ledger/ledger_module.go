...
import (
	...
	accountpkg "github.com/erniealice/fycha-golang/domain/ledger/account"
	...
	accountaction "github.com/erniealice/fycha-golang/domain/ledger/ledger/action"
	dashboardview "github.com/erniealice/fycha-golang/domain/ledger/ledger/dashboard"
	accountdetail "github.com/erniealice/fycha-golang/domain/ledger/ledger/detail"
	fiscalview "github.com/erniealice/fycha-golang/domain/ledger/ledger/fiscal"
	journalview "github.com/erniealice/fycha-golang/domain/ledger/ledger/journal"
	journalactionview "github.com/erniealice/fycha-golang/domain/ledger/ledger/journal_action"
	journaldetailview "github.com/erniealice/fycha-golang/domain/ledger/ledger/journal_detail"
	accountlist "github.com/erniealice/fycha-golang/domain/ledger/ledger/list"
	recurringview "github.com/erniealice/fycha-golang/domain/ledger/ledger/recurring"
	ledgerreports "github.com/erniealice/fycha-golang/domain/ledger/ledger/reports"
	ledgersettings "github.com/erniealice/fycha-golang/domain/ledger/ledger/settings"
	recurringtemplatepkg "github.com/erniealice/fycha-golang/domain/ledger/recurring_template"
)

// LedgerModuleDeps holds all dependencies for the ledger module.
...
type LedgerModuleDeps struct {
	// Account routes
	Routes          accountpkg.Routes
	StatementRoutes accountpkg.StatementRoutes

	// Journal + FiscalPeriod routes (Phase 3)
	JournalRoutes      journalpkg.Routes
	FiscalPeriodRoutes fiscalperiodpkg.Routes

	CommonLabels pyeza.CommonLabels
	TableLabels  types.TableLabels

	// Account labels
	Labels accountpkg.Labels

	// Journal labels (Phase 3)
	JournalLabels journalpkg.Labels

	// FiscalPeriod labels (Phase 3)
	FiscalPeriodLabels fiscalperiodpkg.Labels
	...
	LedgerSettingsRoutes    recurringtemplatepkg.SettingsRoutes
	RecurringTemplateLabels recurringtemplatepkg.Labels
...
// LedgerModule holds all constructed ledger views.
type LedgerModule struct {
	routes          accountpkg.Routes
	statementRoutes accountpkg.StatementRoutes
	journalRoutes   journalpkg.Routes
	fiscalRoutes    fiscalperiodpkg.Routes
...
// NewLedgerModule creates a ledger module with Account views, GL/TB reports, Journal Entry,
// and FiscalPeriod views wired.
func NewLedgerModule(deps *LedgerModuleDeps) *LedgerModule {
	// Default statement routes if not provided
	statementRoutes := deps.StatementRoutes
	if statementRoutes.ActiveNav == "" {
		statementRoutes = accountpkg.DefaultStatementRoutes()
	}
	...
	if settingsRoutes.ActiveNav == "" {
		settingsRoutes = recurringtemplatepkg.DefaultSettingsRoutes()
	}
...
func (m *LedgerModule) RegisterRoutes(r view.RouteRegistrar) {
	...
	r.GET(recurringtemplatepkg.RecurringTemplatesURL, m.RecurringTemplates)
	r.GET(accountpkg.BadDebtPolicyURL, m.BadDebtPolicy)
}
...
func badDebtPolicyView(commonLabels pyeza.CommonLabels, labels accountpkg.Labels) view.View {
