...
// Labels holds all translatable strings for the Chart of Accounts module.
type Labels struct {
	...
	Templates     TemplatesLabels     `json:"templates"`
	GeneralLedger GeneralLedgerLabels `json:"generalLedger"`
	BadDebt       BadDebtLabels       `json:"badDebt"`
	Dashboard     DashboardLabels     `json:"dashboard"`
}

// DashboardLabels holds translatable strings for the Ledger live dashboard
...
// TemplatesLabels holds translatable strings for the Account Templates settings page.
type TemplatesLabels struct {
...
type GeneralLedgerLabels struct {
	Title                 string `json:"title"`
	Subtitle              string `json:"subtitle"`
...
func DefaultLabels() Labels {
	return Labels{
		...
		GeneralLedger: GeneralLedgerLabels{
