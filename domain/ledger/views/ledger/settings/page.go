...
type PageData struct {
	...
	Labels          ledger.AccountTemplatesLabels
...
func buildPreviewEntries(l ledger.AccountFormLabels) []PreviewEntry {
	accounts := seeder.DefaultCoA()
...
func elementLabel(pbElement string, l ledger.AccountFormLabels) string {
	switch pbElement {
	case "ACCOUNT_ELEMENT_ASSET":
...
func classificationLabel(pbClass string, l ledger.AccountFormLabels) string {
	switch pbClass {
