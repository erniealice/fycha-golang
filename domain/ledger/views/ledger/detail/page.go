...
func buildTabItems(id string, labels ledger.AccountLabels, routes ledger.AccountRoutes) []pyeza.TabItem {
...
func fetchAccount(ctx context.Context, deps *Deps, id string, l ledger.AccountLabels) accountViewModel {
...
func protoToViewModel(a *accountpb.Account, l ledger.AccountLabels) accountViewModel {
...
func buildEntriesTable(entries []EntryRow, labels ledger.AccountLabels, tableLabels types.TableLabels, routes ledger.AccountRoutes) *types.TableConfig {
...
func classificationLabel(c accountpb.AccountClassification, l ledger.AccountFormLabels) string {
	switch c {
...
func normalBalanceLabel(n accountpb.NormalBalance, l ledger.AccountFormLabels) string {
	switch n {
...
func cashFlowLabel(c accountpb.CashFlowActivity, l ledger.AccountFormLabels) string {
	switch c {
