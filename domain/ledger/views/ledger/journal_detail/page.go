...
func buildTabItems(id string, labels ledger.JournalLabels, routes ledger.JournalRoutes) []pyeza.TabItem {
...
func protoToViewModel(sl ledger.JournalSourceTypeLabels, e *jepb.JournalEntry) journalViewModel {
...
func buildLinesTable(lines []LineRow, labels ledger.JournalLabels, tableLabels types.TableLabels) *types.TableConfig {
