...
import (
	...
	accountaction "github.com/erniealice/fycha-golang/domain/ledger/views/ledger/action"
	dashboardview "github.com/erniealice/fycha-golang/domain/ledger/views/ledger/dashboard"
	accountdetail "github.com/erniealice/fycha-golang/domain/ledger/views/ledger/detail"
	fiscalview "github.com/erniealice/fycha-golang/domain/ledger/views/ledger/fiscal"
	journalview "github.com/erniealice/fycha-golang/domain/ledger/views/ledger/journal"
	journalactionview "github.com/erniealice/fycha-golang/domain/ledger/views/ledger/journal_action"
	journaldetailview "github.com/erniealice/fycha-golang/domain/ledger/views/ledger/journal_detail"
	accountlist "github.com/erniealice/fycha-golang/domain/ledger/views/ledger/list"
	recurringview "github.com/erniealice/fycha-golang/domain/ledger/views/ledger/recurring"
	ledgerreports "github.com/erniealice/fycha-golang/domain/ledger/views/ledger/reports"
	ledgersettings "github.com/erniealice/fycha-golang/domain/ledger/views/ledger/settings"
)
...
type ModuleDeps struct {
	...
	FiscalPeriodRoutes ledger.FiscalPeriodRoutes
	...
	JournalLabels ledger.JournalLabels

	// FiscalPeriod labels (Phase 3)
	FiscalPeriodLabels ledger.FiscalPeriodLabels
	...
	LedgerSettingsRoutes    ledger.LedgerSettingsRoutes
	RecurringTemplateLabels ledger.RecurringTemplateLabels
...
func NewModule(deps *ModuleDeps) *Module {
	...
	if settingsRoutes.ActiveNav == "" {
		settingsRoutes = ledger.DefaultLedgerSettingsRoutes()
	}
...
func (m *Module) RegisterRoutes(r view.RouteRegistrar) {
	...
	r.GET(ledger.RecurringTemplatesURL, m.RecurringTemplates)
	r.GET(ledger.BadDebtPolicyURL, m.BadDebtPolicy)
}
...
func badDebtPolicyView(commonLabels pyeza.CommonLabels, labels ledger.AccountLabels) view.View {
