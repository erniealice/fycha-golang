...
import (
	...
	capitalaccounts "github.com/erniealice/fycha-golang/domain/ledger/views/equity/capitalaccounts"
	dashboardview "github.com/erniealice/fycha-golang/domain/ledger/views/equity/dashboard"
	equitytransactions "github.com/erniealice/fycha-golang/domain/ledger/views/equity/equitytransactions"
...
type ModuleDeps struct {
	Routes       ledger.EquityRoutes
	Labels       ledger.EquityLabels
...
func (m *Module) RegisterRoutes(r view.RouteRegistrar) {
	...
	r.GET(ledger.EquityAccountsURL, m.CapitalAccounts)
	r.GET(ledger.EquityTransactionsURL, m.EquityTransactions)
}
