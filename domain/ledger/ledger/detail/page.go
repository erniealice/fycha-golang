...
func buildTabItems(id string, labels accountpkg.Labels, routes accountpkg.Routes) []pyeza.TabItem {
...
func fetchAccount(ctx context.Context, deps *Deps, id string, l accountpkg.Labels) accountViewModel {
...
func protoToViewModel(a *accountpb.Account, l accountpkg.Labels) accountViewModel {
...
func buildEntriesTable(entries []EntryRow, labels accountpkg.Labels, tableLabels types.TableLabels, routes accountpkg.Routes) *types.TableConfig {
	columns := []types.TableColumn{
		{Key: "date", Label: labels.Columns.Date, WidthClass: "col-lg"},
		{Key: "entry_number", Label: labels.Columns.EntryNumber, WidthClass: "col-xl"},
...
func classificationLabel(c accountpb.AccountClassification, l accountpkg.FormLabels) string {
	switch c {
...
func normalBalanceLabel(n accountpb.NormalBalance, l accountpkg.FormLabels) string {
	switch n {
...
func cashFlowLabel(c accountpb.CashFlowActivity, l accountpkg.FormLabels) string {
	switch c {
