...
import (
	...
	"github.com/erniealice/fycha-golang/domain/ledger/seeder"
)
...
type PageData struct {
	...
	Labels          accountpkg.TemplatesLabels
...
func buildPreviewEntries(l accountpkg.FormLabels) []PreviewEntry {
	accounts := seeder.DefaultCoA()
...
func elementLabel(pbElement string, l accountpkg.FormLabels) string {
	switch pbElement {
	case "ACCOUNT_ELEMENT_ASSET":
...
func classificationLabel(pbClass string, l accountpkg.FormLabels) string {
	switch pbClass {
