...
func protoToRow(a *accountpb.Account, l accountpkg.Labels) AccountRow {
	return AccountRow{
		ID:             a.GetId(),
		Code:           a.GetCode(),
		Name:           a.GetName(),
...
func accountColumns(l accountpkg.Labels) []types.TableColumn {
	return []types.TableColumn{
		{Key: "code", Label: l.Columns.Code, NoSort: true, WidthClass: "col-lg"},
		{Key: "name", Label: l.Columns.Name, NoSort: true},
		{Key: "element", Label: l.Columns.Element, NoSort: true, WidthClass: "col-xl"},
		{Key: "class", Label: l.Columns.Classification, NoSort: true, WidthClass: "col-2xl"},
		{Key: "balance", Label: l.Columns.Balance, NoSort: true, WidthClass: "col-3xl", Align: "right"},
	}
}

func buildTableRows(accounts []AccountRow, element string, l accountpkg.Labels, routes accountpkg.Routes, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
...
func elementLabel(l accountpkg.Labels, element string) string {
	switch element {
	case "asset":
		return l.Tabs.Asset
	case "liability":
...
func BuildAccountTree(accounts []AccountRow, l accountpkg.FormLabels) []AccountRow {
	if len(accounts) == 0 {
		return accounts
	}
