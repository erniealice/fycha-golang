...
func ElementOptions(l accountpkg.FormLabels) []pyeza.SelectOption {
...
func ClassOptions(element string, l accountpkg.FormLabels) []pyeza.SelectOption {
	switch element {
	case "asset":
		return []pyeza.SelectOption{
...
func CashFlowOptions(l accountpkg.FormLabels) []pyeza.SelectOption {
	return []pyeza.SelectOption{
