...
type Deps struct {
	Routes       payroll.PayrollEmployeeRoutes
...
func employeeColumns(l payroll.PayrollLabels) []types.TableColumn {
...
func buildTableRows(employees []EmployeeRow, l payroll.PayrollLabels, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
...
func payFrequencyLabel(l payroll.PayrollLabels, freq string) string {
	switch freq {
	case "semi-monthly":
