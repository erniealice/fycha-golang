...
type Deps struct {
	Routes       payroll.PayrollRemittanceRoutes
...
func remittanceColumns(l payroll.PayrollLabels) []types.TableColumn {
...
func buildTableRows(remittances []RemittanceRow, status string, l payroll.PayrollLabels, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
...
func remittanceTypeLabel(l payroll.PayrollLabels, t string) string {
	switch t {
	case "sss":
...
func remittanceStatusLabel(l payroll.PayrollLabels, status string) string {
	switch status {
	case "pending":
...
func remittanceStatusTitle(l payroll.PayrollLabels, status string) string {
	switch status {
	case "pending":
...
func remittanceStatusSubtitle(l payroll.PayrollLabels, status string) string {
	switch status {
	case "pending":
