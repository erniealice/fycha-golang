...
import (
	...
	dashboardview "github.com/erniealice/fycha-golang/domain/treasury/views/loans/dashboard"
	loanlist "github.com/erniealice/fycha-golang/domain/treasury/views/loans/loanlist"
	loanpayments "github.com/erniealice/fycha-golang/domain/treasury/views/loans/loanpayments"
...
type ModuleDeps struct {
	// Routes
	Routes        treasury.LoanRoutes
	PaymentRoutes treasury.LoanPaymentRoutes

	// Labels
	Labels        treasury.LoanLabels
	PaymentLabels treasury.LoanPaymentLabels
...
func (m *Module) RegisterRoutes(r view.RouteRegistrar) {
	...
	r.GET(treasury.LoanListURL, m.LoanList)
	r.GET(treasury.LoanPaymentListURL, m.LoanPayments)
	r.GET(treasury.LoanAmortizationURL, comingSoonView("Amortization Schedules", "loans", "amortization"))
}
