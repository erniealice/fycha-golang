...
type PettyCashDeps struct {
	Routes       treasury.PettyCashRoutes
	Labels       treasury.PettyCashLabels
...
func pettyCashRegisterColumns(l treasury.PettyCashLabels) []types.TableColumn {
...
func buildPettyCashRegisterRows(items []MockPettyCashFund, l treasury.PettyCashLabels, routes treasury.PettyCashRoutes, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
