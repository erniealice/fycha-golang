...
func (m *Module) RegisterRoutes(r view.RouteRegistrar) {
	// Petty Cash
	r.GET(treasury.PettyCashRegisterURL, comingSoonView("Petty Cash Register", "cash", "petty-cash-register"))
	r.GET(treasury.PettyCashReplenishmentListURL, comingSoonView("Replenishments", "cash", "replenishments"))
	r.GET(treasury.PettyCashCustodianBalancesURL, comingSoonView("Custodian Balances", "cash", "custodian-balances"))
}
