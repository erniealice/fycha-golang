...
func pettyCashRegisterColumns(l Labels) []types.TableColumn {
...
func buildPettyCashRegisterRows(items []MockPettyCashFund, l Labels, routes Routes, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
