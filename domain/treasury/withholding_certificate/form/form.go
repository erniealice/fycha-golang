...
import (
	wc "github.com/erniealice/fycha-golang/domain/treasury/withholding_certificate"
)
...
// BuildLabels converts Labels to the flat Labels struct.
func BuildLabels(l wc.Labels) Labels {
	return Labels{
