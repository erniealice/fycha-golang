...
func fundKindLabel(l fundinglabels.FundingSourceKindLabels, k fundpb.FundKind) string {
	switch k {
...
func fundStatusLabel(l fundinglabels.FundingSourceStatusLabels, s fundpb.FundStatus) string {
	switch s {
