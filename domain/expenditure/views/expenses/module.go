...
func (m *Module) RegisterRoutes(r view.RouteRegistrar) {
	// Prepayments
	r.GET(expenditure.PrepaymentListURL, comingSoonView("Prepayments", "expenses", "prepayments"))
	r.GET(expenditure.PrepaymentAmortizationURL, comingSoonView("Amortization Schedule", "expenses", "prepayment-amortization"))
}
