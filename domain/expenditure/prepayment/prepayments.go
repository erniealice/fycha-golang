...
func prepaymentColumns(l Labels) []types.TableColumn {
...
func buildPrepaymentRows(items []MockPrepayment, l Labels, routes Routes, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
...
func prepaymentStatusLabel(l Labels, status string) string {
	switch status {
