...
func resolveAssetActions(asset MockAssetDetail, routes asset.Routes, labels asset.Labels) AssetActions {
...
func buildTabItems(id string, labels asset.Labels, routes asset.Routes) []pyeza.TabItem {
...
func buildTransactionTable(history []TransactionRow, labels asset.Labels, tableLabels types.TableLabels) *types.TableConfig {
