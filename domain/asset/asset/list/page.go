...
func assetColumns(l asset.Labels) []types.TableColumn {
...
func statusTitle(l asset.Labels, status string) string {
	switch status {
	case "active":
...
func statusSubtitle(l asset.Labels, status string) string {
	switch status {
	case "active":
...
func statusEmptyTitle(l asset.Labels, status string) string {
	switch status {
	case "active":
...
func statusEmptyMessage(l asset.Labels, status string) string {
	switch status {
	case "active":
...
func buildBulkActions(l asset.Labels, common pyeza.CommonLabels, status string, routes asset.Routes, perms *types.UserPermissions) []types.BulkAction {
