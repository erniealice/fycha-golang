...
func resolveAssetActions(asset MockAssetDetail, routes asset.AssetRoutes, labels asset.AssetLabels) AssetActions {
...
func buildTabItems(id string, labels asset.AssetLabels, routes asset.AssetRoutes) []pyeza.TabItem {
...
func buildTransactionTable(history []TransactionRow, labels asset.AssetLabels, tableLabels types.TableLabels) *types.TableConfig {
