...
import (
	...
	detailform "github.com/erniealice/fycha-golang/domain/asset/views/depreciation_run/detail/form"
	drshared "github.com/erniealice/fycha-golang/domain/asset/views/depreciation_run/shared"
...
type DetailViewDeps struct {
	Routes       asset.DepreciationRunRoutes
	Labels       asset.DepreciationRunLabels
...
func buildTabItems(l asset.DepreciationRunLabels, id string, routes asset.DepreciationRunRoutes) []pyeza.TabItem {
...
func buildSelectionsTable(entries []drshared.DepreciationRunEntryRow, l asset.DepreciationRunLabels, tableLabels types.TableLabels) *types.TableConfig {
...
func buildResultsTable(entries []drshared.DepreciationRunEntryRow, l asset.DepreciationRunLabels, tableLabels types.TableLabels) *types.TableConfig {
	columns := []types.TableColumn{
		{Key: "asset", Label: l.List.Columns.Scope, NoSort: true, WidthClass: "col-6xl"},
		{Key: "period_start_date", Label: l.Detail.Summary.AsOfDate, NoSort: true, WidthClass: "col-3xl"},
...
func buildTransactionsTable(txs []drshared.AssetTransactionRow, l asset.DepreciationRunLabels, tableLabels types.TableLabels) *types.TableConfig {
	columns := []types.TableColumn{
		{Key: "asset", Label: l.List.Columns.Scope, NoSort: true, WidthClass: "col-6xl"},
...
func entryOutcomeCell(l asset.DepreciationRunLabels, outcome string) (label, variant string) {
	switch outcome {
	case "created":
