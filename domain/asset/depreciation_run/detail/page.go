...
import (
	...
	detailform "github.com/erniealice/fycha-golang/domain/asset/depreciation_run/detail/form"
...
func buildTabItems(l depreciationrun.Labels, id string, routes depreciationrun.Routes) []pyeza.TabItem {
...
func buildSelectionsTable(entries []drshared.DepreciationRunEntryRow, l depreciationrun.Labels, tableLabels types.TableLabels) *types.TableConfig {
...
func buildResultsTable(entries []drshared.DepreciationRunEntryRow, l depreciationrun.Labels, tableLabels types.TableLabels) *types.TableConfig {
	columns := []types.TableColumn{
		{Key: "asset", Label: l.List.Columns.Scope, NoSort: true, WidthClass: "col-6xl"},
		{Key: "period_start_date", Label: l.Detail.Summary.AsOfDate, NoSort: true, WidthClass: "col-3xl"},
...
func buildTransactionsTable(txs []drshared.AssetTransactionRow, l depreciationrun.Labels, tableLabels types.TableLabels) *types.TableConfig {
	columns := []types.TableColumn{
		{Key: "asset", Label: l.List.Columns.Scope, NoSort: true, WidthClass: "col-6xl"},
...
func entryOutcomeCell(l depreciationrun.Labels, outcome string) (label, variant string) {
	switch outcome {
	case "created":
