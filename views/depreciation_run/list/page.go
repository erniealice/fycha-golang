...
func depreciationRunColumns(l fycha.DepreciationRunLabels) []types.TableColumn {
	lc := l.List.Columns
...
func statusBadge(l fycha.DepreciationRunLabels, status string) (label, variant string) {
	switch status {
	case "pending":
...
func scopeKindLabel(l fycha.DepreciationRunLabels, kind string) string {
	switch kind {
	case "asset":
...
func statusPageTitle(l fycha.DepreciationRunLabels, status string) string {
	switch status {
	case "pending":
...
func statusEmptyTitle(l fycha.DepreciationRunLabels, status string) string {
	switch status {
	case "pending":
...
func statusEmptyMessage(l fycha.DepreciationRunLabels, status string) string {
	switch status {
	case "pending":
