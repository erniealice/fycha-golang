...
type PageData struct {
	...
	Labels            report.ExpenditureReportLabels
...
func buildSummary(s *dspb.ExpenditureReportSummary, l report.ExpenditureReportLabels) []report.SummaryMetric {
	if s == nil {
...
func buildPivotTable(resp *dspb.GetExpenditureReportResponse, l report.ExpenditureReportLabels, tableLabels types.TableLabels, primary, rowDim string) *types.TableConfig {
