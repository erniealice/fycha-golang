...
type PageData struct {
	...
	Labels            report.DisbursementReportLabels
...
func buildSummary(s *dspb.DisbursementReportSummary, l report.DisbursementReportLabels) []report.SummaryMetric {
	if s == nil {
...
func buildPivotTable(resp *dspb.GetDisbursementReportResponse, l report.DisbursementReportLabels, tableLabels types.TableLabels, primary, rowDim string) *types.TableConfig {
