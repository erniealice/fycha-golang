...
type PageData struct {
	...
	Labels            report.ReceivablesAgingReportLabels
...
func NewView(deps *Deps) view.View {
	return view.ViewFunc(func(ctx context.Context, viewCtx *view.ViewContext) view.ViewResult {
		...
		table.ToolbarPrefixData = report.AgingToolbarPrefixData{
...
func buildSummary(s *aragingpb.ReceivablesAgingSummary, l report.ReceivablesAgingReportLabels) []report.SummaryMetric {
	if s == nil {
...
func buildTable(resp *aragingpb.GetReceivablesAgingResponse, l report.ReceivablesAgingReportLabels, tableLabels types.TableLabels, rowDim string) *types.TableConfig {
...
func rowDimensionLabel(l report.ReceivablesAgingReportLabels, dim string) string {
