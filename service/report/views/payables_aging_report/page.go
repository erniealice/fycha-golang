...
type PageData struct {
	...
	Labels            report.PayablesAgingReportLabels
...
func buildSummary(s *apagingpb.PayablesAgingSummary, l report.PayablesAgingReportLabels) []report.SummaryMetric {
	if s == nil {
...
func buildTable(resp *apagingpb.GetPayablesAgingResponse, l report.PayablesAgingReportLabels, tableLabels types.TableLabels, rowDim string) *types.TableConfig {
...
func rowDimensionLabel(l report.PayablesAgingReportLabels, dim string) string {
